...
(async() => {
    allText = await readTextFile("https://mjbarcenas.github.io/keybored/assets/texts/easy_words.txt");
    allQuotes = await readTextFile("https://mjbarcenas.github.io/keybored/assets/texts/quotes.txt");
